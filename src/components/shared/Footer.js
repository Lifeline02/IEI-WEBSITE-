            ...
            <div className="container">
                  ...
                  >
                    ...
                    <div className="footer__widget-content">
                      <div className="footer__links">
                        <ul>
                          <li>
                            <a href="benefitApplication">Benfit Application</a>
                          </li>
                          <li>
                            <a href="penCalculator">Pension Calculator</a>
                          </li>
                          <li>
                            <a href="unitPrice">Unit Price</a>
                          </li>
                          <li>
              ...
              <div className="mobile_app">
                <a href="https://tinyurl.com/mthtpkzf" className="px-3">
                  <img
                    src="/assets/img/mobile/playstore.png"
                    alt="Android"
                    width="240px"
                    height="70px"
                  />
                ...
                <a href="https://tinyurl.com/mr2mpcbu" className="px-3">
                  <img
                    src="/assets/img/mobile/apple.png"
                    alt="Android"
                    width="240px"
                    height="70px"
                  />
                ...
                <a href="#" className="px-3 d-inline-block">
                  <img
                    src="/assets/img/mobile/ndpr.png"
                    alt="ndpr audit"
                    width="240px"
                    height="70px"
                  />
