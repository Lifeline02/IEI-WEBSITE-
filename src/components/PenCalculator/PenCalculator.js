...
const PenCalculator = () => {
  ...
  return (
    <>
      <p>
        Are you investing enough to achieve your ideal post-retirement income?{" "}
        Enter your information and select Calculate. Please note that this
        calculator is for illustration purposes only.
      </p>
      <section className="calculator__area">
        <div className="shadow p-3 mb-5 bg-body rounded">
          ...
          <form className="calculator__form" onSubmit={handleSubmit}>
            ...
            <div className="mb-3">
              <label htmlFor="totalMContribution" className="form-label">
                Total Monthly Contribution (in Naira)*
              </label>
              <input
                type="number"
                ref={mContribution}
                className="form-control form-control-sm"
                id="totalMContribution"
              />
            </div>
            <div className="mb-3">
              <label htmlFor="totalVContribution" className="form-label">
                Monthly Voluntary Contribution (in Naira)
              </label>
              <input
                type="number"
                ref={vContribution}
                className="form-control form-control-sm"
                id="totalVContribution"
              />
            </div>
            <div className="mb-3">
              <label htmlFor="expectedRDate" className="form-label">
          ...
          <p>
            You will have ₦{result.toLocaleString("en-US")} at the time of
            retirement. Use our retirement planner to make plans and accomplish
            this objective.
          </p>
        </div>
      </section>
