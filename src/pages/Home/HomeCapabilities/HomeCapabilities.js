    ...
    <>
      <section className="capabilities__area p-relative black-bg-2 pt-180 pb-155 fix">
        <div
          ...
          style={{
            background: `url(assets/img/capabilities/capabilities-img1.png)`,
              ...
              >
                ...
                <div className="capabilities__list">
                  <a
                    ...
                    className="px-3 d-inline-block my-3 "
                  >
                    <img
                      src="assets/img/mobile/playstore-1.png"
                      alt="Android"
                      width="240px"
                      height="70px"
                    />
                  ...
                  <a href="https://tinyurl.com/mr2mpcbu" className="px-3">
                    <img
                      src="assets/img/mobile/apple-1.png"
                      alt="Android"
                      width="240px"
                      height="70px"
                    />
