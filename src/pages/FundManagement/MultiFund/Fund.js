          ...
          <div className="row">
            <div className="col-xl-6">
              <div className="section-title section__title-3 mb-70">
                <h2>Get to know about all the Fund type </h2>
                <p>We help you plan your today for your better tomorrow</p>
              </div>
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-xl-12">
              <div className="services__tab grey-bg-18">
                <div className="tab-content" id="services-content">
                  ...
                  >
                    <HomeThreeSecondSingleService title="RSA FUND I" />
                    body= ''
                  </div>
                  <div
                  ...
                  >
                    <HomeThreeSecondSingleService title="RSA FUND II" />
                  </div>
                  <div
                    className="tab-pane fade"
                    id="social"
                  ...
                  >
                    <HomeThreeSecondSingleService
                      title="RSA FUND III"
                      body="Enjoy the convenience of monitoring your RSA account anywhere and anytime by using our online statement. Sign up today."
                    />
                  </div>
                  <div className="tab-pane fade" id="financial" role="tabpanel">
